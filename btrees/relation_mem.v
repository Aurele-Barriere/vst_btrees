...
Definition _free : ident := 110%positive.
...
Definition _malloc : ident := 109%positive.
                          ...
                          (Sassign
                            (Ederef
                              (Ebinop Oadd
                                ...
                                (Etempvar _i tulong) (tptr tint)) tint)
                            (Econst_int (Int.repr 0) tint))
                          (Sassign
                            (Ederef
                              (Ebinop Oadd
...
Definition f_insertKeyRecord := {|
  ...
  fn_temps := ((_success, tint) :: (_childTreePtrIdx, tint) ::
               ...
               (_t'56, tint) :: (_t'55, tulong) :: (_t'54, tulong) ::
               (_t'53, (tptr (Tstruct _BtNode noattr))) ::
               (_t'52, (tptr (Tstruct _BtNode noattr))) :: (_t'51, tulong) ::
               (_t'50, tint) :: (_t'49, (tptr (Tstruct _BtNode noattr))) ::
               (_t'48, tint) :: (_t'47, (tptr (Tstruct _BtNode noattr))) ::
               (_t'46, tulong) :: (_t'45, tint) ::
               (_t'44, (tptr (Tstruct _BtNode noattr))) :: (_t'43, tint) ::
               (_t'42, tint) :: (_t'41, tulong) ::
               (_t'40, (tptr (Tstruct _Relation noattr))) ::
               (_t'39, (tptr (Tstruct _Relation noattr))) ::
               (_t'38, tulong) :: (_t'37, tint) :: (_t'36, tint) ::
               (_t'35, tulong) :: (_t'34, tulong) :: (_t'33, tint) ::
               (_t'32, tint) :: (_t'31, tulong) ::
               (_t'30, (tptr (Tstruct _Relation noattr))) ::
               (_t'29, (tptr (Tstruct _Relation noattr))) ::
               (_t'28, tulong) :: (_t'27, tint) :: (_t'26, tulong) ::
               (_t'25, (tptr (Tstruct _BtNode noattr))) :: (_t'24, tint) ::
               (_t'23, (tptr (Tstruct _BtNode noattr))) :: (_t'22, tint) ::
               (_t'21, tulong) :: (_t'20, tint) :: (_t'19, tint) ::
               (_t'18, tulong) :: (_t'17, tint) :: (_t'16, tulong) ::
               (_t'15, (tptr (Tstruct _Relation noattr))) ::
               (_t'14, (tptr (Tstruct _Relation noattr))) :: (_t'13, tint) ::
               (_t'12, tint) :: nil);
  fn_body :=
(Ssequence
                      ...
                      (Scall (Some _t'1)
                        ...
                        ((Efield
                           (Ederef
                             ...
                             (Tstruct _BtNode noattr)) _entries
                           (tarray (Tstruct _Entry noattr) 15)) ::
                         (Etempvar _key tulong) :: (Etempvar _t'61 tint) ::
                         nil)))
                              ...
                              (Sset _t'43
                                (Efield
                                  (Ederef
                                    (Etempvar _node (tptr (Tstruct _BtNode noattr)))
                                    (Tstruct _BtNode noattr)) _numKeys tint))
                              (Sifthenelse (Ebinop Olt (Etempvar _t'43 tint)
                                                          ...
                                                          (Ssequence
                                                            ...
                                                            (Sassign
                                                              (Efield
                                                                ...
                                                                _ptr0
                                                                (tptr (Tstruct _BtNode noattr)))
                                                              (Etempvar _t'52 (tptr (Tstruct _BtNode noattr)))))
                                                          (Ssequence
                                                            (Ssequence
                                                              (Sset _t'51
                                                                (Efield
                                                              ...
                                                              (Ssequence
                                                                ...
                                                                (Ssequence
                                                                  (Ssequence
                                                                    ...
                                                                    (tptr (tptr (Tstruct _BtNode noattr))))
                                                                    (tptr (Tstruct _BtNode noattr)))
                                                                    (Etempvar _t'49 (tptr (Tstruct _BtNode noattr)))))
                                                                    (Ssequence
                                                                    (Sset _t'48
                                                                    (Ederef
                                                                    (Ebinop Oadd
                    ...
                    (Sset _t'37
                      (Efield
                        (Ederef
                          (Etempvar _node (tptr (Tstruct _BtNode noattr)))
                          (Tstruct _BtNode noattr)) _numKeys tint))
                    (Sifthenelse (Ebinop Oeq (Etempvar _t'37 tint)
                                   (Econst_int (Int.repr 0) tint) tint)
                      (Ssequence
                        (Sassign
                          (Efield
                              ...
                              (Sassign
                                (Efield
                                  (Ederef
                                    (Etempvar _node (tptr (Tstruct _BtNode noattr)))
                                    (Tstruct _BtNode noattr)) _numKeys tint)
                                (Ebinop Oadd (Etempvar _t'42 tint)
                                  (Econst_int (Int.repr 1) tint) tint)))
                            (Ssequence
                              (Sassign
                                (Efield
                        ...
                        (Scall (Some _t'7)
                          ...
                          ((Efield
                             (Ederef
                               ...
                               (Tstruct _BtNode noattr)) _entries
                             (tarray (Tstruct _Entry noattr) 15)) ::
                           (Etempvar _key tulong) :: (Etempvar _t'36 tint) ::
                           nil)))
                          ...
                          (Efield
                            (Ederef
                              (Ebinop Oadd
                                ...
                                (tptr (Tstruct _Entry noattr)))
                              (Tstruct _Entry noattr)) _key tulong))
                        (Sifthenelse (Ebinop Oeq (Etempvar _t'34 tulong)
                        ...
                        (Sset _t'13
                          (Efield
                            (Ederef
                              (Etempvar _node (tptr (Tstruct _BtNode noattr)))
                              (Tstruct _BtNode noattr)) _numKeys tint))
                        (Sifthenelse (Ebinop Olt (Etempvar _t'13 tint)
                              ...
                              (Ssequence
                                ...
                                (Scall (Some _t'8)
                                  ...
                                  ((Efield
                                     ...
                                     (tarray (Tstruct _Entry noattr) 15)) ::
                                   (Etempvar _key tulong) ::
                                   (Etempvar _t'33 tint) :: nil)))
                              (Sset _targetIdx__2 (Etempvar _t'8 tint)))
                            (Ssequence
                              (Ssequence
                                (Sset _i__3
                                  (Efield
                          ...
                          (Ssequence
                            ...
                            (Ssequence
                              (Ssequence
                                ...
                                (Sset _targetIdx__3 (Etempvar _t'9 tint)))
                              (Ssequence
                                                              ...
                                                              (Ssequence
                                                                ...
                                                                (Ssequence
                                                                  ...
                                                                  (Ssequence
                                                                    ...
                                                                    (Efield
                                                                    (Ederef
                                                                    (Etempvar _t'14 (tptr (Tstruct _Relation noattr)))
                                                                    (Tstruct _Relation noattr))
                                                                    _numRecords
                                                                    tulong)
                                                                    (Ebinop Oadd
...
(_RL_PrintTree :: _RL_NumRecords :: _RL_IsEmpty :: _RL_GetKey ::
 ...
 _RL_DeleteRelation :: _RL_NewRelation :: _fprintf :: _stderr :: _free ::
 _malloc :: ___assert_fail :: ___builtin_debug :: ___builtin_nop ::
