...
Another substantial difference between \lstinline{findChildIndex} and \lstinline{findRecordIndex} is that \todo{inclusive, exclusive. Because of the spec and the def}.
...
For instance, VST doesn't allow to verify an assignment where the type is a user-defined structure. \todo{why?}
