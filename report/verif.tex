...
This is particularly useful to extract information from a separation construct. \todo{example: refer to the sub-node\_rep lemma}
...
\textbf{Fig.}~\ref{btnoderep} shows one of these definitions.\todo{move that to annex!}
