...
DeepDB already contained a formal model that complied with the abstract relation axiomatization\todo{ref brian thesis}.
...
% Types explanation
\textbf{Fig.}~\ref{fig:coqtypes} presents the Coq Types for \btrees, cursors and relations. \todo{update for dependent relation type}
...
For instance, \textbf{Fig.}~\ref{fig:movetofirst} presents the coq \texttt{moveToFirst} function.\todo{why isn't label working?}
