...
In particular, accessing the record of each key sequentially has amortized constant time complexity\todo{ref tosin's thesis}.
...
\begin{multicols}{2}
\lstinputlisting[language=C]{types.c}
\end{multicols}
...
This library contains 37 functions, all of which will be verified in section\todo{ref section}.
