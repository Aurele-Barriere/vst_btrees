...
\begin{frame}{The Verified Software Toolchain}
  ...
  \begin{block}{Using VST}
    ...
    \item Define a Coq formal model
...
Definition RL_MoveToNext_spec : ident * funspec :=
 ...
 \begin{tikzpicture}[remember picture, overlay,%
      ...
      \draw[draw=prog,fill=prog] ([yshift=-0.4cm]S) rectangle ++(0.1cm,0.8cm);
 \end{tikzpicture}
 \begin{tikzpicture}[remember picture, overlay,%
      ]
      \node[anchor=north west,
  ...
  \addtocounter{framenumber}{1}
    ...
    \begin{frame}[standout]
      \begin{tikzpicture}[remember picture,overlay]
        ...
        \node[anchor=north west, xshift=6.5cm, yshift=-4.1cm] at (current page.north west) (S) {};
        \draw[draw=prog,fill=prog] (S) rectangle ++(0.1cm,0.6cm);
        \node[anchor=north west, xshift=6.5cm, yshift=-3.41cm] at (current page.north west) (P) {};
        \draw[draw=spec,fill=spec] (P) rectangle ++(0.1cm,0.65cm);
        \node[anchor=north west, xshift=8.15cm, yshift=-4.2cm] at (current page.north west) (Q) {};
        \draw[draw=spec,fill=spec] (Q) rectangle ++(1.2cm,0.1cm);
 \end{tikzpicture}
    \end{frame}
    \begin{frame}[standout]
      \begin{tikzpicture}[remember picture,overlay]
